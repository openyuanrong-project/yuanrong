...
#include "org_yuanrong_jni_Producer.h"
#include <jni.h>
...
JNIEXPORT jobject JNICALL Java_org_yuanrong_jni_JniProducer_sendHeapBufferDefaultTimeout(JNIEnv *env, jclass,
...
JNIEXPORT jobject JNICALL Java_org_yuanrong_jni_JniProducer_sendDirectBufferDefaultTimeout(JNIEnv *env, jclass,
...
JNIEXPORT jobject JNICALL Java_org_yuanrong_jni_JniProducer_sendHeapBuffer(JNIEnv *env, jclass, jlong handle,
...
JNIEXPORT jobject JNICALL Java_org_yuanrong_jni_JniProducer_sendDirectBuffer(JNIEnv *env, jclass, jlong handle,
...
JNIEXPORT jobject JNICALL Java_org_yuanrong_jni_JniProducer_close(JNIEnv *env, jclass, jlong handle)
{
    auto producer = reinterpret_cast<std::shared_ptr<YR::Libruntime::StreamProducer> *>(handle);
...
JNIEXPORT void JNICALL Java_org_yuanrong_jni_JniProducer_freeJNIPtrNative(JNIEnv *, jclass, jlong handle)
{
    auto producer = reinterpret_cast<std::shared_ptr<YR::Libruntime::StreamProducer> *>(handle);
    delete producer;
}
